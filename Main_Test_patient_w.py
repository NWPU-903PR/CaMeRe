...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_c_s', type=float, default=0.9,
                        help='Learning rate of classifer for meta-learning update')
    parser.add_argument('--lr_l_s', type=float, default=0.5,
                        help='Learning rate of feature_sem for meta-learning update')
    ...
    #
    for tissue in ["COL","OVA","BRE","LUN","BRA"]:
        #
        # read date
        ...
        #test
        if tissue == "COL":
            step_best, mcc_best = 625, 0.234375

        elif tissue == "OVA":
            step_best, mcc_best = 1495, 0.334228515625

        elif tissue == "BRE":
            step_best, mcc_best = 1195, 0.281494140625

        elif tissue == "LUN":
            step_best, mcc_best = 1335, 0.271484375

        elif tissue == "BRA":
            step_best, mcc_best = 995, 0.188720703125
