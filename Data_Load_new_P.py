...
def Load_Synergydata(tissue_t,seed):
    ...
    # fold_len = int(len(sample_files)/k)
    # test_files = sample_files[fold_len * fold :fold_len * (fold + 1)]
    test_files = [tissue_t]
...
class MiniSynergyDataSet():
    ...
    def sample_new_batch_train(self, data_pack,obj):
        ...
        for i in range(self.batch_size):
            ...
            for x in choose_tissue:
                ...
                for patient_unlabel in choose_patient:
                    ...
                    patient_unlabeled_samples.extend(np.array(patient_unlabeled[patient_unlabel])[choose_samples,0:3])
        ...
        # print(np.shape(query_samples_labeled))
