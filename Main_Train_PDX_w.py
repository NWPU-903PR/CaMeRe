...
def val_mddan(meta,synergydata,best_mcc,best_step,step,args):
    ...
    for _ in range(args.num_rep_val // 1):
        ...
        x_support_set, x_support_unlabel_set, x_target = synergydata.get_val_batch(obj=args.object_val, augment=False)  # 产生样本
        # print(x_support_set)
        # cell lines
    ...
    if mcc_patient > best_mcc:
        ...
        save_path =args.save_models+ "{}_{}_{}_{}_{}_w10.pth".format(args.object,best_step, best_mcc, tissue,args.seed)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_l_a', type=float, default=0.001, help='Learning rate of feature_sem for meta-learning update')
    ...
    parser.add_argument('--lr_d_s', type=float, default=1, help='Learning rate of features_var for meta-learning update')
    ...
    parser.add_argument('--wdl', type=float, default=0.00005, help='weight decay of feature_sem for meta-learning update')
    ...
    parser.add_argument('--wdd', type=float, default=0.00005, help='weight decay of features_var for meta-learning update')
    ...
    # parser.add_argument("--cnn", type=int, default=1, help='the number of cell in each train query')
    # parser.add_argument("--k", type=int, default=4, help='the number of K-fold test')
    ...
    for tissue in ["COL","SKI","BRE","LUN"]:
        ...
        experiment_nameT = f'CaMeRe_comb_Train_pdx'
        experiment_nameval = f'CaMeRe_comb_VAL_pdx'
