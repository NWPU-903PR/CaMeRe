...
if __name__ == '__main__':
    ...
    SDF2CSV('data/featrue/drug_2d_cell.sdf', 'data/feature/drug_smiles_cell.csv')
    CSV2JSON('data/featrue/', 'drug_smiles_cell.csv', 'drug_smiles_cell.json', flag="drug")
    geneate_direction('data/featrue/', "drug_smiles_cell.json", "drug_graph_cell.json")
